...
static const unsigned int gappih     = 10;  /* Горизонтальный внутренний отступ между окнами */
static const unsigned int gappiv     = 10;  /* Вертикальный внутренний отступ между окнами */
static const unsigned int gappoh     = 10;  /* Горизонтальный внешний отступ между окнами и краем экрана */
static const unsigned int gappov     = 10;  /* Вертикальный внешний отступ между окнами и краем экрана */
static const int          smartgaps  = 0;   /* 1: нет внешних отступов, если одно окно; 0: всегда есть */
static const int          showbar    = 1;   // 1: отображать статусбар, 0: скрыть
static const int          topbar     = 1;   // 1: бар сверху, 0: бар снизу
static const int          horizpadbar= 15;  /* Горизонтальные отступы внутри статусбара */
...
static const unsigned int ulinepad     = 7;  /* Горизонтальный отступ между подчеркиванием и текстом тега */
static const unsigned int ulinestroke  = 2;  /* Толщина подчеркивания */
static const unsigned int ulinevoffset = 0;  /* Смещение линии вверх от нижнего края бар */
...
static const int   resizehints = 1;  // 1: учитывать подсказки приложений при изменении размера
...
static const Key keys[] = {
    ...
    { MODKEY|ControlMask, XK_y,    incrohgaps,     {.i = +3 } }, // Горизонтальные внешние
